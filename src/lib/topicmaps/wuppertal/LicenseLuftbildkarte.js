...
const Comp = () => {
  return (
    <li>
      ...
      <strong>True Orthophoto ausBildflug vom 16.03.2022</strong>, hergestellt durch Aerowest
      ...
      <strong>Stadtkarte 2.0</strong> und <strong>Kartenschrift aus der Stadtkarte 2.0</strong>.

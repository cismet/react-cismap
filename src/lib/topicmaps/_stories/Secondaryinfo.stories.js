...
import GenericSecondaryInfo from '../GenericSecondaryInfo';
import GenericSecondaryInfoPanelSection from '../GenericSecondaryInfoPanelSection';
			...
			<GenericSecondaryInfo
				...
				mainSection={
					<div style={{ fontSize: '115%', padding: '10px', paddingTop: '0px' }}>
						...
						<div>
							Als ausgebildete Informatiker mit langjähriger Berufserfahrung verfügt
							unser Personal ausnahmelos über das notwendige Know-How zum Entwurf und
							der Umsetzung von Informationssystemen.{' '}
						</div>
						<br />
						<div>
							<b>Bemerkung:</b>
						...
						<div>
							Hierzu gehören ein grundlegendes und theoretisch fundiertes Verständnis
							der Bereiche Datenbankentwurf, Softwareentwurf und Programmierung.
						</div>
						<br />
						<div>
				...
				subSections={[
					...
					<GenericSecondaryInfoPanelSection
						...
						content={
							<div>
								...
								EU-Projekten sind Integrationskonzepte & Architekturen, insbesondere
								im Bereich Geodatenintegration, die für den Aufbau von
								Geodateninfrastrukturen unerlässlich sind.
							</div>
						}
					/>,
					<GenericSecondaryInfoPanelSection
					...
					<GenericSecondaryInfoPanelSection
						...
						content={
							<div>
								Durch unsere nationale und internationale, thematisch weit gestreute
								Projekte verfügen wir über ein weit reichendes Partner-Netzwerk mit
								renomierten Unternehmen, Behörden, Universitäten und
					...
					<GenericSecondaryInfoPanelSection
						...
						content={
							<div>
								...
								Architekturen verteilter komplexer Informationssystem auf Tagungen
								und in Journals verbinden wir Theorie und Praxis.
							</div>
						}
					/>
				]} //<GenericSecondaryInfoPanelSection >

export const storiesCategory = "TopicMap Components/";
export const parkscheinautomatenfeatures = [
  {
    crs: {
      type: "name",
      properties: {

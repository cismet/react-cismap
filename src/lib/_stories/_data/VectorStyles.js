export const alkis_flurstuecke_style = {
    ...
    "sources": {
        "alkis_data": {
            ...
            "tiles": [
                ...
                // "https://tiles.cismet.de/alkis/{z}/{x}/{y}.pbf"
            ],
            "minzoom": 9,
            "maxzoom": 17
        }
    ...
    "sprite": "https://tiles.cismet.de/alkis_laak_3857_17/sprites",
    "layers": [
        {
            "id": "landparcel_fill",
            "type": "fill",
            ...
            "metadata": {
                carmaConf: {
                    selectionForwardingTo: ["landparcel", "landparcel_point", "landparcel_arrows", "landparcel_arrows_tips"],
                    staticProps: { "source-layer": "landparcel" }
                }
            },
            "paint": {
                "fill-color": "#FAFF13",
        ...
        },
        {
            ...
            "source-layer": "landparcel",
            "metadata": {
                carmaConf: { selectionForwardingTo: ["landparcel", "landparcel_point", "landparcel_arrows", "landparcel_arrows_tips"] }
            },
            "paint": {
                "line-color": "#FAFF13",
                "line-width": {
...
export const alkis_flurstuecke_style_original = {
    "version": 8,
    "sources": {
        "alkis_data": {
            "type": "vector",

...
import { FeatureCollectionDisplayWithTooltipLabels, MappingConstants, RoutedMap } from "../..";
...
export const Simple = () => {
  ...
  return (
    <div>
      ...
      <div>
        We used Tooltips in this component to show alphanumerical information. While it is ok for
        polygons, it is a little bit tricky for points. better use{" "}
